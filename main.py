from dao import ProjectsRepository
...
def load_all_items_from_database(repository):
    ...
    for p in projects:
        ...
        print("ID = {} | Title = {} | Price = {}"
              .format(tmp_project._id, tmp_project.title, tmp_project.price))
...
def test_delete(repository, new_project):
    ...
    if not found:
        print("Item with id = {} was not found in the database"
              .format(new_project._id))
...
def main():
    ...
    new_project = Project.build_from_json({
        "title": "Wordpress website for Freelancers",
        "description": """This should be a very simple website, based on
        wordpress with functionalities for Freelancers""",
        "price": 250,
